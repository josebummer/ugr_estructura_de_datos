...
public:
	...
	*/
	conjunto::iterator find (const value_type & s);
	conjunto::const_iterator  find (const value_type & s) const;
	...
	*/
	...
	conjunto::size_type count (const value_type & e) const;
	...
	*/
	...
	pair<conjunto::iterator,bool> insert (conjunto::value_type& val);
	...
	*/
	conjunto::iterator  erase (const conjunto::iterator position);
	conjunto::size_type erase (const conjunto::value_type& val);
	...
	*/
	...
	@post no modifica el conjunto.
	*/
	conjunto::iterator lower_bound (const conjunto::value_type& val);
	conjunto::const_iterator lower_bound (const conjunto::value_type& val) const;
	...
	@post no modifica el conjunto.
	*/
  conjunto::iterator upper_bound (const conjunto::value_type& val);
	conjunto::const_iterator upper_bound (const conjunto::value_type& val) const;

	/** @brief imprime todas las entradas del conjunto
	@post No se modifica el conjunto.
	Implementar tambien esta funcion
		*/
	friend ostream &  operator << ( ostream & sal, const conjunto<T,CMP> & C);

	/** @brief Muestra un elemento del conjunto
			@param pos: posicion donde se encuentra el elemento a mostrar
	*/

	void getElem( conjunto::iterator pos ) const;
